...
import { useGoogleAuth, useFacebookAuth, useAppleAuth } from "@/features/auth/hooks/useSocialAuth";
        ...
        >
          ...
          <View style={[styles.card, { backgroundColor: colors.background }]}>
            ...
            <View style={styles.socialColumn}>
              <SocialButton
                provider="google"
                label={socialLoading === "google" ? "Đang xử lý..." : t().auth.continueWithGoogle}
              ...
              {Platform.OS === "ios" && appleAuth.available && (
                <SocialButton
                  provider="apple"
                  label={socialLoading === "apple" ? "Đang xử lý..." : t().auth.continueWithApple}
              ...
              <SocialButton
                provider="facebook"
                label={
                  socialLoading === "facebook" ? "Đang xử lý..." : t().auth.continueWithFacebook
                }
